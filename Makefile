...
SRC = $(wildcard src/*.c) $(wildcard src/pppd/*.c) $(wildcard src/dhcpd/*.c) $(wildcard src/dhcpd6/*.c) $(wildcard src/nd6/*.c) $(wildcard src/dnsd/*.c)
OBJ = $(SRC:.c=.o)
...
######################################
# Coverage measurement (unit + e2e + per-feature)
######################################
include e2e_test/coverage.mk
