...
RULES = [
    ...
    ("DNS proxy",
     r"src/dnsd/",
     r"^(dns_|dnsd_)"),
    ("IPv6 neighbor discovery (RA/SLAAC/NDP)",
     r"src/nd6/",
     r"^nd6_"),
    ("DHCPv6-PD client",
     r"src/dhcpd6/",
     r"^dhcp6_"),
    ("IPv6 firewall",
     r"src/pppd/ipv6_firewall\.h$",
     r"^(ipv6_firewall_|icmp6_)"),
    ("MAC/ARP resolution",
     r"src/mac_table\.c$",
    ...
    ("Controller sync (SDN)",
     r"(northbound/(controller|grpc)/|src/(etcd_integration|controller)\.c$|src/etcd_event\.h$)",
    ...
    ("CLI",
     r"(northbound/cmdline/|src/cli_request\.c$)",
     r"^cli_request_"),
]
